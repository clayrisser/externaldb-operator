...
// +kubebuilder:rbac:groups=externaldb.databases.land,resources=connectionmysqls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=externaldb.databases.land,resources=connectionmysqls/status,verbs=get;update;patch

func (r *ConnectionMysqlReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	_ = context.Background()
	_ = r.Log.WithValues("connectionmysql", req.NamespacedName)
...
func (r *ConnectionMysqlReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&externaldbv1alpha1.ConnectionMysql{}).
		Complete(r)
}
