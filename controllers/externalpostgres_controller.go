...
// +kubebuilder:rbac:groups=externaldb.databases.land,resources=externalpostgres,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=externaldb.databases.land,resources=externalpostgres/status,verbs=get;update;patch

func (r *ExternalPostgresReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	_ = context.Background()
	_ = r.Log.WithValues("externalpostgres", req.NamespacedName)
...
func (r *ExternalPostgresReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&externaldbv1alpha1.ExternalPostgres{}).
		Complete(r)
}
