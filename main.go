...
import (
	...
	"github.com/codejamninja/externaldb-operator/controllers"
...
func init() {
	...
	utilruntime.Must(externaldbv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "8003b2d0.databases.land",
	})
	if err != nil {
	...
	if err = (&controllers.ExternalPostgresReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("ExternalPostgres"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ExternalPostgres")
		os.Exit(1)
	}
	if err = (&controllers.ConnectionPostgresReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("ConnectionPostgres"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
